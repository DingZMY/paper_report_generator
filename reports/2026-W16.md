...
> **收录论文**：40 篇（已翻译 0 篇）
> **生成时间**：2026-04-17 08:31 UTC

---



## 1. Correlation of CheY-P concentration and motor behavior during attractant adaptation in single E. coli cells.
...
## 2. Competing gene regulatory networks drive naive and memory B cell differentiation.
...
## 3. Engineering a compact high-fidelity Staphylococcus aureus Cas9 variant with broader targeting range and mechanistic insights into its activation.
...
## 4. Improved l-Cysteine Production in Corynebacterium glutamicum through Metabolic Engineering and High-Throughput Screening.
...
## 5. Guidance of cellular nematic elastomers into shape-programmable living surfaces.

| 字段 | 内容 |
|---|---|
| **期刊** | Science |
| **发表日期** | 2026-Apr-16 |
| **作者** | Guillamat Pau, Mirza Waleed, Bal Pradeep K, Gómez-González Manuel, Roca-Cusachs Pere, Arroyo Marino, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1126/science.adz9174) |
...
**关键词**：Elastomers · Morphogenesis · Animals · Biomechanical Phenomena · Stress, Mechanical


---


## 6. Engineering Rapamycin-Induced Dimerization for Control of Gene Expression in Plants.
...
## 7. Glucose is dynamically regulated by time of day in humans and Drosophila.
...
## 8. A community reconstruction of Chinese hamster metabolism and structural systems biology elucidate metabolic rewiring in lactate-free CHO cells.
...
## 9. Mapping convergent regulators of melanoma drug resistance by PerturbFate.
...
## 10. Molecular basis for methylation-sensitive editing by Cas9.

| 字段 | 内容 |
|---|---|
| **期刊** | Nature |
| **发表日期** | 2026-Apr-15 |
| **作者** | Roth Mitchell O, Shu Yuerong, Zhao Yu, Trasanidou Despoina, Hoffman Renee D, Südfeld Christian, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41586-026-10384-z) |
...
## 11. Inducible, split base editors for in vivo cancer functional genomics.
...
## 13. Genome-wide CRISPR screens in primary human natural killer cells identify countermeasures against immunosuppressive environment.
...
## 14. On the role of L-type Ca2+ and BK channels in a biophysical model of cartwheel interneurons.
...
## 15. How muscle ageing affects rapid goal-directed movement: mechanistic insights from a simple model.
...
## 16. Epigenetics and chromatin structure regulate var2csa expression and the placental-binding phenotype in Plasmodium falciparum.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Apr-15 |
| **作者** | Lenz Todd, Sirel Madle, Hoppe Hannes, Shafeeq Sulman, Le Roch Karine G, Ribacke Ulf |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.93632) |
| **DOI** | `10.7554/eLife.93632` |
...
**关键词**：Plasmodium falciparum · Placenta · Female · Epigenesis, Genetic · Chromatin · Antigens, Protozoan · Humans · Pregnancy · Malaria, Falciparum · Antigenic Variation


---


## 17. Efficient Synthesis of Ectoine in Escherichia coli via Multistep Metabolic Engineering Modification.
...
## 18. Constructing a holistic map of cell fate decision by hyper solution landscape.
...
## 19. Deep coverage and extended sequence reads obtained with a single archaeal protease expedite de novo protein sequencing by mass spectrometry.
...
## 20. The metabolome of an E. coli CRISPRi library identifies benefits of minimal metabolite levels and targets for engineering.
...
## 21. Electromagnetic field-inducible in vivo gene switch for remote spatiotemporal control of gene expression.
...
## 22. Neural signaling contributes to heart formation and growth in the invertebrate chordate, Ciona robusta.
...
## 23. PHYCUT: Scalable Multiplex CRISPR/Cas9 Editing for Genome Engineering in the Diatom Phaeodactylum tricornutum.
...
## 24. Active regulation of the epidermal growth factor receptor by the membrane bilayer.
...
## 25. Enhanced bacterial chemotaxis in confined microchannels occurs at lane widths matching circular swimming radius.
...
## 26. Kinesin-1 conformational dynamics are controlled by a cargo-sensitive TPR switch.
...
## 27. Ubiquitylation of DNA polymerase β via atypical K27 chains signals a DNA damage response.
...
## 28. A versatile CRISPR-associated transposases-mediated toolkit for transcriptional regulation library.
...
## 29. Proinsulin regulators identified with CRISPR screen and in vivo mouse QTL mapping.
...
## 30. Genome-Wide CRISPR/Cas9 Screening Reveals BmM-ALP Orchestrates the Antioxidant Response and Metabolic Adaptations for Heat Resistance in Bombyx mori.
...
## 31. Nonlinear effects of noise on outbreaks of mosquito-borne diseases.
...
## 32. Efficient genome editing with chimeric oligonucleotide-directed editing.
...
## 33. Prompt-Only Gene-Circuit Modeling with a Large Language Model Simulates the synNotch Spheroids.
...
## 34. Metabolic adaptation drives self-organization during skin organoid morphogenesis.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Apr-11 |
| **作者** | Jiang Jingwei, Liu Weiwei, Wang Mengyue, Wang Dehuan, Wu Wang, Zhang Man, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-71709-0) |
| **DOI** | `10.1038/s41467-026-71709-0` |
...
## 35. An information content principle explains regulatory patterns of gene expression across human tissues.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Apr-11 |
| **作者** | Golomb Ruthie, Yoles Maayan, Fishilevich Simon, Cohen Bar, Peled Sapir Savariego, Dahary Dvir, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-71279-1) |
| **DOI** | `10.1038/s41467-026-71279-1` |
...
## 36. Rapid formation of non-spatial hippocampal representations consistent with behavioral timescale synaptic plasticity is modulated by entorhinal input.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Apr-10 |
| **作者** | Dorian Conor C, Taxidis Jiannis, Arac Ahmet, Golshani Peyman |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-71503-y) |
...
## 37. Efficiency, accuracy and robustness of probability generating function based parameter inference method for stochastic biochemical reactions.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Comput Biol |
| **发表日期** | 2026-Apr |
| **作者** | Li Shiyue, Wang Yiling, Shu Zhanpeng, Grima Ramon, Jiang Qingchao, Cao Zhixing |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pcbi.1014160) |
...
**关键词**：Stochastic Processes · Computational Biology · Algorithms · Models, Biological · Computer Simulation · Probability · Kinetics · Models, Statistical


---


## 38. Elucidating the Metabolic Landscape of p-Coumaric Acid to Deepen Biological Implication and Enhance Biomanufacturing.
...
## 39. Principles of gamma synchrony predict figure-ground perception in texture stimuli.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Apr-10 |
| **作者** | Karimian Maryam, Roberts Mark Jonathan, De Weerd Peter, Senden Mario |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.105482) |
...
**关键词**：Humans · Visual Cortex · Male · Female · Adult · Photic Stimulation · Gamma Rhythm · Visual Perception · Young Adult


---


## 40. GTPase-activating protein DLC1 spatio-temporally regulates Rho signaling.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Apr-10 |
| **作者** | Hinderling Lucien, Heydasch Max, Rochat Giliane, Dubied Laurent, van Unen Jakobus, Dobrzynski Maciej, et al. |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.90305) |
...
**关键词**：GTPase-Activating Proteins · Signal Transduction · Humans · Tumor Suppressor Proteins · rho GTP-Binding Proteins · Focal Adhesions · Animals · Fibroblasts · Mice
