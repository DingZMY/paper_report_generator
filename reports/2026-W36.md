# 系统/合成生物学文献周报 2026-W36

> **时间范围**：2026/08/24 ~ 2026/08/31
> **来源期刊**：Nature / Cell / Science 系列
> **收录论文**：34 篇（已翻译 0 篇）
> **生成时间**：2026-08-31 02:30 UTC

---



## 1. A programmable lipid-triggered allosteric site modulates LC3 LIR receptor binding activity.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-28 |
| **作者** | Gahlot Deepanshi, Castin Jesu, Mathur Shruti, Das Debajyoti, Kumar Ajit, Arun Akanksha, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-76697-9) |
...
**关键词**：Microtubule-Associated Proteins · Protein Binding · Allosteric Site · Autophagy · Humans · Crystallography, X-Ray · Molecular Dynamics Simulation · Protein Conformation · Autophagosomes · Lipids
...
| **期刊** | Cell |
| **发表日期** | 2026-Aug-28 |
| **作者** | Zhu Ronghui, Dann Emma, Yan Jun, Reyes Retana Justine, Goto Ryunosuke, Guitche Reese C, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1016/j.cell.2026.08.002) |
...
## 3. Antibody Fc receptor CD16a mediates natural killer cell activation via mechanotransduction of piconewton forces.

| 字段 | 内容 |
|---|---|
| **期刊** | Sci Adv |
| **发表日期** | 2026-Aug-28 |
| **作者** | Ma Rong, Garcia K Christopher, Cui Bianxiao, Covert Markus W |
| **原文链接** | [查看原文](https://doi.org/10.1126/sciadv.aeb8946) |
...
**关键词**：Receptors, IgG · Killer Cells, Natural · Mechanotransduction, Cellular · Lymphocyte Activation · Humans · Phosphorylation · Signal Transduction


---


## 4. Maladaptive immune-fibrotic axis drives impaired long bone regeneration under mechanical instability.

| 字段 | 内容 |
|---|---|
| **期刊** | Sci Adv |
| **发表日期** | 2026-Aug-28 |
| **作者** | Patrick Matthew D, Ahn Jaimo, Hankenson Kurt D, Annamalai Ramkumar T |
| **原文链接** | [查看原文](https://doi.org/10.1126/sciadv.adx7511) |
...
**关键词**：Animals · Mice · Bone Regeneration · Fracture Healing · Fibrosis · Macrophages · Disease Models, Animal · Biomechanical Phenomena · Stress, Mechanical


---


## 5. Wafer-scale SOT-MRAM for analog crossbar array applications.

| 字段 | 内容 |
|---|---|
| **期刊** | Sci Adv |
| **发表日期** | 2026-Aug-28 |
| **作者** | Liu Samuel, Rogers Vivian, Hu Chen-Yu, Song Ming-Yuan, Bao Xinyu, Incorvia Jean Anne C |
| **原文链接** | [查看原文](https://doi.org/10.1126/sciadv.aee6952) |
...
## 6. Ecological theory sheds light on plasmid diversity and dynamics.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Biol |
| **发表日期** | 2026-Aug |
| **作者** | Tuffet Rémi, Acacia Emma, Coluzzi Charles, Charpentier Xavier, Koffel Thomas, Venner Samuel |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pbio.3003918) |
...
**关键词**：Plasmids · Genome, Bacterial · Gene Transfer, Horizontal · Bacteria · Evolution, Molecular · Genetic Variation · Ecology · Models, Genetic


---


## 7. Disentangling the drivers of heterogeneity in SARS-CoV-2 transmission from data on viral load and daily contact rates.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Comput Biol |
| **发表日期** | 2026-Aug-28 |
| **作者** | Quilty Billy J, Chapman Lloyd A C, Munday James D, Wong Kerry L M, Gimma Amy, Pickering Suzanne, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pcbi.1014715) |
| **DOI** | `10.1371/journal.pcbi.1014715` |
...
## 8. Noradrenergic infraslow rhythm during sleep is the critical link between heart-rate dynamics and memory consolidation.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Aug-28 |
| **作者** | Jacobsen Sofie S, Morehouse Allison B, Chen Pin-Chun, Qian Yi, Gomolka Ryszard S, Andersen Mie, et al. |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.110252) |
| **DOI** | `10.7554/eLife.110252` |
...
**关键词**：Animals · Humans · Memory Consolidation · Heart Rate · Locus Coeruleus · Sleep · Mice · Male · Norepinephrine · Female


---


## 9. The structure of the native cardiac crossbridge in the rigor state.

| 字段 | 内容 |
|---|---|
| **期刊** | Sci Adv |
| **发表日期** | 2026-Aug-28 |
| **作者** | Risi Cristina M, Nguyen Tyler, Belknap Betty, White Howard D, Pinto Jose R, Chase Prescott B, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1126/sciadv.aeg1209) |
...
**关键词**：Animals · Tropomyosin · Troponin · Actin Cytoskeleton · Models, Molecular · Actins · Myocardium · Myosins · Protein Conformation · Myocardial Contraction


---


## 10. Cis glycan-glycan interactions organize membrane nanodomains that tune receptor signaling.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-27 |
| **作者** | Suzuki Kenichi G N, Komura Naoko, Asano Sachi, Takahashi Maina, Yamaguchi Eriko, Yamazaki Ayano, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-76857-x) |
| **DOI** | `10.1038/s41467-026-76857-x` |
...
**关键词**：ErbB Receptors · Polysaccharides · Signal Transduction · Membrane Microdomains · Cell Membrane · Humans · Animals · Lipid Bilayers · G(M3) Ganglioside · Protein Multimerization


---


## 11. De novo design of RNA pseudoknots with deep learning.

| 字段 | 内容 |
|---|---|
| **期刊** | Science |
| **发表日期** | 2026-Aug-27 |
| **作者** | Townley Jill, Kladwang Wipapat, Baker David, Blair Hamish M, Choe Christian A, El Nesr Gina, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1126/science.aeg6829) |
...
**关键词**：Deep Learning · RNA · Nucleic Acid Conformation · Generative Artificial Intelligence · Cryoelectron Microscopy · RNA Folding · Models, Molecular · Humans


---


## 12. Systematic analysis of network-driven adaptive resistance to CDK4/6 and oestrogen receptor inhibition using meta-dynamic network modelling.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Aug-27 |
| **作者** | Hart Anthony, Shin Sung-Young, Nguyen Lan K |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.87710) |
...
**关键词**：Cyclin-Dependent Kinase 4 · Humans · Drug Resistance, Neoplasm · Receptors, Estrogen · Signal Transduction · Cyclin-Dependent Kinase 6 · Models, Biological · Antineoplastic Agents


---


## 13. Disruption of sphingolipid metabolism promotes tau seeding through endolysosomal membrane rigidification and rupture.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Aug-27 |
| **作者** | Tittelmeier Jessica, Sandhof Carl Alexander, Martin Nicole, El-Kabarity Deike, Ngonza-Nito Soki-Bradel, Melki Ronald, et al. |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.106865) |
| **DOI** | `10.7554/eLife.106865` |
...
**关键词**：Animals · Sphingolipids · tau Proteins · Caenorhabditis elegans · Humans · Lysosomes · Endosomes · Membrane Fluidity · Intracellular Membranes


---


## 14. Spatiotemporal 4D Whole-cell Modeling of a Minimal Autotroph Reveals Central Carbon Metabolism Regulated Locally by Protein Megacomplexes via Post-translational Modifications under Light Disturbance.

| 字段 | 内容 |
|---|---|
| **期刊** | Biophys J |
| **发表日期** | 2026-Aug-26 |
| **作者** | Johnson Connah G M, Chan Aaron, Rozum Jordan, George August, Parvate Amar D, Bohutskyi Pavlo, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1016/j.bpj.2026.08.020) |
| **DOI** | `10.1016/j.bpj.2026.08.020` |
...
## 15. Automated prototyping of genetic codes.

| 字段 | 内容 |
|---|---|
| **期刊** | Nature |
| **发表日期** | 2026-Aug-26 |
| **作者** | Radford Felix, Sapers Nayan, Burgess Hana M, Ort Lucy, Budnik Bogdan, Church George M |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41586-026-10949-y) |
...
## 16. State-dependent binding of the wedge domain controls inactivation of the mechanosensitive ion channel PIEZO1.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-26 |
| **作者** | Roettger Lucas, Zeitzschel Nadja, Gorzelanny Christian, Verkest Clement, Lechner Stefan G |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-76927-0) |
...
**关键词**：Ion Channels · Animals · Protein Domains · Mutagenesis, Site-Directed · Mechanotransduction, Cellular · Ion Channel Gating · Humans · Protein Binding · HEK293 Cells


---


## 17. Single-cell and in vivo profiling reveal heterogeneous and organ-specific CRISPR-Cas9 off-target and translocation outcomes.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-26 |
| **作者** | Madsen Alexandra, Selfjord Niklas, Martinez-Lage Marta, Loyd Anna-Lena, Kurgan Gavin, Ståhlberg Mikaela, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-77144-5) |
| **DOI** | `10.1038/s41467-026-77144-5` |
...
**关键词**：Animals · CRISPR-Cas Systems · Mice · Single-Cell Analysis · Gene Editing · Organ Specificity · DNA Methylation · Embryonic Stem Cells · Chromatin · Translocation, Genetic


---


## 18. Heritable transgenic schistosomes as a living platform for SARS-CoV-2 neutralizing antibody secretion.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-26 |
| **作者** | Ittiprasert Wannaporn, Smout Michael J, Mann Victoria H, Moyle Matthew, Kinahan Sean M, Ackerman Daniel N, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-76465-9) |
...
## 20. Simulation and inference methods for non-Markovian stochastic reaction networks.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Comput Biol |
| **发表日期** | 2026-Aug-26 |
| **作者** | Steele Thomas P, Warne David J |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pcbi.1014687) |
| **DOI** | `10.1371/journal.pcbi.1014687` |
...
## 21. Modeling the influences of non-local connectomic projections on geometrically constrained cortical dynamics.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Comput Biol |
| **发表日期** | 2026-Aug-26 |
| **作者** | Maran Rishikesan, Müller Eli J, Fulcher Ben D |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pcbi.1014673) |
...
## 22. Dynamic Landscape Analysis of cell fate decisions provides predictive models of neural development from single-cell data.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Biol |
| **发表日期** | 2026-Aug-26 |
| **作者** | Fontaine Marine, Delás M Joaquina, Sáez Meritxell, Maizels Rory J, Finnie Elizabeth, Briscoe James, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pbio.3003953) |
...
## 23. A membrane insertion code for intrinsically disordered proteins.

| 字段 | 内容 |
|---|---|
| **期刊** | Elife |
| **发表日期** | 2026-Aug-26 |
| **作者** | Kunnath Muhammedkutty Fidha Nazreen, Zhou Huan-Xiang |
| **原文链接** | [查看原文](https://doi.org/10.7554/eLife.111515) |
| **DOI** | `10.7554/eLife.111515` |
...
**关键词**：Intrinsically Disordered Proteins · Molecular Dynamics Simulation · Cell Membrane · Humans · Amino Acid Motifs · Hydrophobic and Hydrophilic Interactions


---


## 24. Transferable genetic toolsets for nonmodel gut Clostridia enable in vivo reversible control of metabolite production.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Biotechnol |
| **发表日期** | 2026-Aug-25 |
| **作者** | Li Ting-Ting, Chen Xi, Wang Fangzhao, Tang Yuelin Angelina, Sim Marissa, Xiao Leyi, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41587-026-03269-z) |
| **DOI** | `10.1038/s41587-026-03269-z` |
...
## 25. Time-dependent bistability leads to critical slowing down during floral transition in Arabidopsis.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-25 |
| **作者** | Rodríguez-Maroto Gabriel, Wang Kang, Casanova-Ferrer Pau, Cerise Martina, Coupland George, Formosa-Jordan Pau |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-76210-2) |
| **DOI** | `10.1038/s41467-026-76210-2` |
...
**关键词**：Arabidopsis · Flowers · Arabidopsis Proteins · Gene Expression Regulation, Plant · Transcription Factors · Homeodomain Proteins · DNA-Binding Proteins · Meristem · MADS Domain Proteins · Time Factors


---


## 26. The multi-omics fallacy in microbiome science.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Comput Biol |
| **发表日期** | 2026-Aug |
| **作者** | Lewandowski Rebecca |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pcbi.1014700) |
| **DOI** | `10.1371/journal.pcbi.1014700` |
...
**关键词**：Multiomics · Microbiota · Humans · Computational Biology · Machine Learning · Artificial Intelligence


---


## 27. Synergistic interaction between the macrophage polarizing signals IL-4 and IFNγ is controlled by the STAT6/STAT1/IRF1 axis.

| 字段 | 内容 |
|---|---|
| **期刊** | Nucleic Acids Res |
| **发表日期** | 2026-Aug-24 |
| **作者** | Varga Zsófia, Poscher Anna, Váradi Eszter Anna, Cinege Gyöngyi, Izsán Antal, Erdős Edina, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1093/nar/gkag825) |
...
**关键词**：Animals · STAT6 Transcription Factor · STAT1 Transcription Factor · Interferon-gamma · Interferon Regulatory Factor-1 · Mice · Interleukin-4 · Macrophages · Signal Transduction · Female


---


## 28. Dual-mode application of transcriptional regulation and DNA editing using the ultra-compact TnpB system.

| 字段 | 内容 |
|---|---|
| **期刊** | Nucleic Acids Res |
| **发表日期** | 2026-Aug-24 |
| **作者** | Oh Yeounsun, Jeon Se-Been, Gwon Lee Wha, Sim Bo-Woong, Lee Seung Hwan |
| **原文链接** | [查看原文](https://doi.org/10.1093/nar/gkag849) |
...
**关键词**：DNA-Binding Proteins · Transcriptional Activation · Sulfolobus solfataricus · DNA · Archaeal Proteins


---


## 29. Chromatin accessibility classification of TAD boundaries discloses new architectural proteins.

| 字段 | 内容 |
|---|---|
| **期刊** | Nucleic Acids Res |
| **发表日期** | 2026-Aug-24 |
| **作者** | Jácome-López Karina, Ledesma-Domínguez Leonardo, Esquivel-López Ayerim, Pérez-Molina Rosario, Pénagos-Puig Andrés, Aguilar-Lomas Amaury, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1093/nar/gkag796) |
| **DOI** | `10.1093/nar/gkag796` |
...
**关键词**：Humans · Chromatin · CCCTC-Binding Factor · K562 Cells · Cohesins · Insulator Elements · Chromosomal Proteins, Non-Histone · Cell Cycle Proteins · DNA-Binding Proteins · Protein Binding


---


## 30. Adaptive model-guided protein evolution with sparse data optimizes compact eukaryotic genome editors.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Biotechnol |
| **发表日期** | 2026-Aug-24 |
| **作者** | Wan Shijie, Gold Jackson, Vure Pranay, Mogilevsky Casey S, Talikoti Ananya, Chen Tianrong, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41587-026-03272-4) |
...
## 31. Supramolecular morphological transition driven by nonequilibrium break-and-build self-organisation.

| 字段 | 内容 |
|---|---|
| **期刊** | Nat Commun |
| **发表日期** | 2026-Aug-24 |
| **作者** | Kubota Ryou, Ikuta Yuriki, Torigoe Shogo, Kanazawa Naoki, Hamachi Itaru |
| **原文链接** | [查看原文](https://doi.org/10.1038/s41467-026-76336-3) |
...
## 32. Mechanochemical modeling of exercise-induced skeletal muscle hypertrophy.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Comput Biol |
| **发表日期** | 2026-Aug-24 |
| **作者** | Devold Ingvild S, Rognes Marie E, Rangamani Padmini |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pcbi.1014691) |
| **DOI** | `10.1371/journal.pcbi.1014691` |
...
## 33. CompBio and MIRaS-a multi-omic analysis platform built on a memory-based intelligence engine.

| 字段 | 内容 |
|---|---|
| **期刊** | Nucleic Acids Res |
| **发表日期** | 2026-Aug-24 |
| **作者** | Barve Ruteja A, Storer Chad E, Hoxsie Wayne D, Marcum Curtis, McMichael Joshua F, Lalmansingh Jared M, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1093/nar/gkag833) |
...
**关键词**：Humans · Multiomics · Artificial Intelligence · Software · Knowledge Bases


---


## 34. Limits of deep-learning-based RNA prediction methods.

| 字段 | 内容 |
|---|---|
| **期刊** | Nucleic Acids Res |
| **发表日期** | 2026-Aug-24 |
| **作者** | Ludaic Marko, Elofsson Arne |
| **原文链接** | [查看原文](https://doi.org/10.1093/nar/gkag813) |
| **DOI** | `10.1093/nar/gkag813` |

### 摘要（英文）

In recent years, tremendous advances have been made in predicting protein structures and protein-protein interactions, but progress on RNA structure, alone or in complex with other macromolecules, has lagged behind despite recent methodological developments. It remains unclear whether reported gains in accuracy generalize to novel RNA structures. Here, we benchmark 10 deep learning methods on an independent, non-redundant dataset of monomeric RNAs and RNA complexes. For monomeric RNA, AlphaFold3 and Boltz-1 achieve the best overall performance, but accuracy depends greatly on similarity to the training set: predictions are reliable mainly for RNAs with well-defined or recurring folds, such as L-shaped and simple loop structures, while structurally divergent RNAs remain poorly modelled. Extending the evaluation to RNA complexes, AlphaFold3 and Boltz-1 substantially outperform HelixFold3 and RosettaFoldNA, with no statistically significant difference between the two leading methods on most measures. Together, these results show that current methods are constrained by limited, structurally biased training data and recognize recurring motifs rather than generalize to novel RNA folds.
...
**关键词**：RNA · Deep Learning · Nucleic Acid Conformation · Prediction Algorithms · RNA Folding · Models, Molecular · Computational Biology · Software · Algorithms
