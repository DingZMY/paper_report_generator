...
## 7. Polyphosphate modulates the stress-responsive formation of functional RNA-protein condensates in bacteria and mammalian cells.

| 字段 | 内容 |
|---|---|
| **期刊** | PLoS Biol |
| **发表日期** | 2026-Apr-27 |
| **作者** | Guan Jian, Hurto Rebecca Lee, Rai Akash, Bhattrai Janakraj, Azaldegui Christopher A, Ortiz-Rodríguez Luis A, et al. |
| **原文链接** | [查看原文](https://doi.org/10.1371/journal.pbio.3003775) |
...
揭示驱动特定生物分子在体内形成相分离凝聚物的因素及其生理意义是至关重要的问题。本研究发现，氮饥饿的大肠杆菌产生长链聚磷酸盐，作为RNA伴侣Hfq的支架，促使其形成高分子量复合物，并最终与RNA翻译和加工机器组分一起发生相分离。凝聚物中的聚磷酸盐通过选择性地稳定参与转录和蛋白质翻译的多聚腺苷酸化RNA，并促进与涉及全新蛋白质合成的翻译及RNA代谢相关蛋白的相互作用，来调控Hfq功能。缺乏聚磷酸盐会显著损害凝聚物形成，增加细胞死亡，并阻碍氮饥饿后的恢复。功能类比显示，聚磷酸盐特异地促进人细胞系中加工小体（P-body）的形成，揭示了一种单一、高度保守的祖先多聚阴离子充当跨生命树功能性相分离凝聚物形成的调节因子。


### 核心发现


- 氮饥饿大肠杆菌产生的长链聚磷酸盐作为支架，诱导Hfq与翻译和RNA代谢组分发生相分离。

- 聚磷酸盐通过稳定多聚腺苷酸化RNA和招募翻译相关蛋白调控Hfq功能，缺失会损害恢复与存活。

- 人细胞中聚磷酸盐特异地促进P-body形成，表明其为跨生命树保守的相分离调控因子。
...
## 8. Diversity in emergent cell locomotion from the coupling cytosolic and cortical Marangoni flows with reaction-diffusion dynamics.
...
## 9. STARCall integrates image stitching, alignment, and read calling to enable scalable analysis of in situ sequencing data.
...
## 10. Systems biology analysis of vasodynamics in mouse cerebral arterioles during resting state and functional hyperemia.
...
## 11. Engineered conductive pili enable high-efficiency photosynthetic electron extraction in biophotovoltaics.
...
## 12. Dango: Predicting higher-order genetic interactions.
...
## 13. Engineered commensals for metabolic modulation of the gut-liver-brain axis.
...
## 14. Condensation-independent intramodular translocation mechanism of the trans-AT polyketide synthase assembly line.
...
## 16. A combinatorial domain screening platform reveals epigenetic effector interactions for transcriptional perturbation.
...
## 17. CRISPRi-based functional genomic screening identifies genes essential for CH4-dependent growth in a methanotrophic bacterium.
...
## 18. Automating population construction and parallel simulation of biophysical models for neuromuscular cells: An inverse approach.
...
## 19. The dual molecular identity of vestibular kinocilia bridges structural and functional traits of primary and motile cilia.
...
## 20. Construction and Application of a Multicolor Bactosensor for Detecting Bioavailable Antibiotic Mixtures in the Environment.
...
## 21. Biomimetic metamaterial-based interface for decoding heterogeneous mechanodermal activity.
...
## 22. Piezo1-mediated mechanohydraulic control of cell volume drives cardiac morphogenesis.
...
## 23. Automated linear DNA assembly of A. thaliana's chloroplast and mitochondrial genome.
...
## 24. Dual role of ZIC2 during neural induction: from priming transcription factor to enhancer activator.
...
## 25. De novo chemo-optogenetics through the rational design of photoresponsive molecules and selection of their artificial protein binding pairs.
...
## 26. Genome editing of phylogenetically distinct bacteria using cross-species retron-mediated recombineering.
...
## 27. Mechanical load inhibits cancer growth in mouse and human hearts.
...
## 28. TBL1X/TBL1XR1 govern β-cell identity through a PAX6-containing gene regulatory network.
...
## 29. Recurrent neural chemical reaction networks that approximate arbitrary dynamics.
...
## 30. Synthetic multicolor antigen-stabilizable nanobody platform for intersectional labeling and functional imaging.
...
## 31. An in vitro approach for simulating divergent Golgi O-glycosylation of tumor-associated MUC1 from normal MUC1.
...
## 32. Integrating theory and machine learning to reveal determinants of plasmid copy number.
...
## 33. Spatio-temporal modelling of in vitro influenza A virus infection: The impact of defective interfering particles on the type I interferon response.
...
## 34. Using experimental results of protein design to guide biomolecular energy-function development.
...
## 35. A quantitative in vivo CRISPR-imaging platform identifies regulators of hyperplastic and hypertrophic adipose morphology in zebrafish.
